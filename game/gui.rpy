...
define gui.accent_color = '#222034'

## 텍스트 버튼(text button)이 선택(selected)됐거나 커서를 올리지(hovered) 않았을
## 때 사용됩니다.
define gui.idle_color = '#4a447d'
...
define gui.text_color = '#9badb7'
define gui.interface_text_color = '#9badb7'
